...
{
	cout<<"Enter the no. of edges: ";    // ask user about no of braches as v = no.of branches
	cin>>v;
	...
	{
		cout<<"Enter the end branches of connections:  ";         //ask for two ends point of each connection 
		cin>>l>>u;
